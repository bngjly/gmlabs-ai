...
// ── 时间轴（长/短两版） ──────────────────────────────────────────────────
// 2026-08-25 再收紧（EP02实测）：EP01的180s窗口套到EP02文案上，
// 前4场景(hook/strong/weak/cisco)缓冲仍有6-10s。按EP02实测音频+1.5s重排（DUR 146.1）。
// 注意：此表被所有集共用；EP01已发布定稿不受影响，未来新集仍应先测TTS再收紧。
const LONG = {
  hook:[0,7.3], strong:[7.3,21.8], weak:[21.8,49.5], cisco:[49.5,72.7],
  proof:[72.7,95.7], mean:[95.7,120.6], cta:[120.6,138.1], end:[138.1,146.1], DUR:146.1,
};
const SHORT = {
